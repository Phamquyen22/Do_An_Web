(function ($) {
  ...
  var thang = currentDate.toLocaleString('en-us', { month: 'short' });
  ...
  function makeTimer() {
    ...
    var dateString = `${ngay + 6} ${thang} ${nam} ${gio}:${phut}:${giay} GMT${currentDate.getTimezoneOffset() > 0 ? '-' : '+'}${Math.abs(currentDate.getTimezoneOffset() / 60).toString().padStart(2, '0')}:00`;
